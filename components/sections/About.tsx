...
export default function About() {
  return (
    ...
    >
      {/* Inner container to keep content from stretching too wide */}
      <div className="w-full max-w-5xl mx-auto">
        <div className="mb-16 md:mb-20 w-full">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <p className="text-left md:text-right text-neutral-700">
              We design what we build, and we build what ships.
            </p>
          </div>
        </div>

        {/* Make it 1-column until lg, then 12-column */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left text card */}
          <div className="lg:col-span-7 bg-neutral-100 rounded-2xl p-8 md:p-10 text-left">
            ...
            <div className="space-y-4 text-neutral-600 leading-relaxed">
              ...
              <p>
                Portfolios, product sites, and high-conversion landers for SaaS
                and iOS apps. Built with intention. Delivered fast.
              </p>
            </div>
          ...
          {/* Black stats card */}
          <div className="lg:col-span-5 bg-black rounded-2xl p-8 md:p-10 text-white text-left">
          ...
          <div className="lg:col-span-5 bg-white rounded-2xl p-8 border border-neutral-200">
            3
          </div>

          {/* Code editor card */}
          <div className="lg:col-span-7 bg-[#1e1e1e] rounded-2xl overflow-hidden text-left">
            ...
            <div className="p-5 font-mono text-[13px] leading-relaxed text-left">
              <div className="text-[#569cd6]">
                const <span className="text-[#4fc1ff]">stack</span> =
