                ...
                <Link href="/" className="inline-flex items-center" aria-label="THIRD LINE">
                    ...
                    >
                        <g id="black">
                            ...
                            <path d="M105.15,0h26.55v40.65h37.65V0h26.55v107.25h-26.55v-44.7h-37.65v44.7h-26.55V0Z" />
                            <path d="M237.75,0h26.55v107.25h-26.55V0Z" />
                            <path d="M306,0h51.3c5.3,0,10.25.67,14.85,2.02,4.6,1.35,8.57,3.33,11.92,5.93,3.35,2.6,5.97,5.83,7.88,9.67,1.9,3.85,2.85,8.28,2.85,13.27,0,6.3-1.53,11.65-4.58,16.05-3.05,4.4-7.73,7.7-14.03,9.9v.45c4.7,1.6,8.27,3.93,10.73,6.98,2.45,3.05,4.07,7.27,4.88,12.67.6,3.5.97,6.93,1.12,10.28.15,3.35.32,6.35.52,9,.2,2.65.5,4.85.9,6.6.4,1.75,1.05,2.78,1.95,3.08v1.35h-25.8c-.7-.4-1.23-1.42-1.57-3.08-.35-1.65-.65-3.65-.9-6-.25-2.35-.48-4.9-.67-7.65-.2-2.75-.5-5.48-.9-8.17-.7-5-2.43-8.8-5.17-11.4-2.75-2.6-6.97-3.9-12.67-3.9h-16.05v40.2h-26.55V0ZM352.5,47.4c5.3,0,9.27-1.15,11.93-3.45,2.65-2.3,3.97-5.5,3.97-9.6s-1.28-7.1-3.83-9.6c-2.55-2.5-6.38-3.75-11.47-3.75h-20.55v26.4h19.95Z" />
                            <path d="M412.64,0h45.75c7.4,0,14.15,1.3,20.25,3.9,6.1,2.6,11.33,6.25,15.68,10.95,4.35,4.7,7.72,10.4,10.12,17.1,2.4,6.7,3.6,14.15,3.6,22.35,0,9.5-1.6,17.93-4.8,25.27-3.2,7.35-7.8,13.33-13.8,17.92-4.2,3.2-9,5.62-14.4,7.28-5.4,1.65-11.5,2.47-18.3,2.47h-44.1V0ZM454.79,84.9c8.8,0,15.4-2.62,19.8-7.88,4.4-5.25,6.6-12.83,6.6-22.73s-2.25-17.6-6.75-23.4c-4.5-5.8-10.95-8.7-19.35-8.7h-15.9v62.7h15.6Z" />
                            <path d="M611.39,0h26.55v84.75h48.15v22.5h-74.7V0Z" />
                            <path d="M702.29,0h26.55v107.25h-26.55V0Z" />
                            <path d="M770.54,0h26.7l31.8,53.85c.4.8,1.02,1.95,1.88,3.45.85,1.5,1.67,3,2.48,4.5,1,1.8,2,3.7,3,5.7h.3c-.1-2.4-.15-4.7-.15-6.9-.1-1.9-.15-3.75-.15-5.55V0h25.95v107.25h-26.7l-31.5-53.1c-.5-.7-1.18-1.82-2.03-3.38-.85-1.55-1.68-3.17-2.47-4.88-1-1.9-2.05-3.95-3.15-6.15h-.3c0,2.6.05,5.05.15,7.35,0,2,.02,3.98.07,5.92.05,1.95.08,3.38.08,4.27v49.95h-25.95V0Z" />
                            <path d="M883.04,0h81.3v21.9h-54.75v19.2h46.95v20.7h-46.95v22.95h55.65v22.5h-82.2V0Z" />
                        </g>
                    </svg>
                </Link>
