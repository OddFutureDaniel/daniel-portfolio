    ...
    return (
        <Section id="process"
            ...
            <div className="flex flex-col mb-10 w-full">
                <Subheading className="text-[16px] uppercase tracking-[0.2em] text-neutral-400 font-medium" align="left">How We Work
                </Subheading>
                <Subheading className="mt-4 text-3xl md:text-4xl font-semibold tracking-tight text-black!" align="left">A simple process, <br /> exceptional results
                </Subheading>
            </div>
            <div className="flex flex-wrap items-start justify-center gap-4">
                <Card className="flex-1 min-w-[345px] h-[500px] max-w-sm p-8">
                    <CardHeader className="flex flex-row flex-nowrap gap-4 items-center mb-6">
                        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-sm font-semibold text-neutral-600">1</span>
                        <CardTitle className="text-xs uppercase tracking-wider text-neutral-400 font-medium">Disovery</CardTitle>
                    </CardHeader>
                    <CardDescription>
                        <Subheading className="text-[16px] text-neutral-500 leading-relaxed mb-8">30-minute chat to understand your goals, timeline, and success criteria.
                        </Subheading>
                    </CardDescription>
                    <CardContent>
                        <div className="rounded-xl bg-neutral-900 overflow-hidden shadow-xl">
                            <div className="flex items-center gap-2 bg-neutral-800 px-3 py-2 border-b border-white/5">
                                ...
                                <span className="relative flex h-2 w-2">
                                    ...
                                    <span className="text-[9px] text-white/50 font-medium">REC
                                    </span>
                                </div>
                            </div>
                            <div className="p-2 grid grid-cols-2 gap-2">
                                <div className="aspect-video rounded bg-neutral-800 flex items-center justify-center">
                                    <div className="h-8 w-8 rounded-full bg-neutral-700 flex items-center justify-center text-[10px] font-medium text-white/60">You
                                    </div>
                                </div>
                                <div className="aspect-video rounded bg-neutral-800 flex items-center justify-center ring-1 ring-emerald-500/30">
                                    <div className="h-8 w-8 rounded-full bg-black flex items-center justify-center text-[10px] font-bold text-white border border-emerald-500/40">DR
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <Card className="flex-1 min-w-[345px] h-[500px] max-w-sm p-8">
                    <CardHeader className="flex flex-row flex-nowrap gap-4 items-center mb-6">
                        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-sm font-semibold text-neutral-600">2</span>
                        <CardTitle className="text-xs uppercase tracking-wider text-neutral-400 font-medium">Collaboration</CardTitle>
                    </CardHeader>
                    <CardDescription>
                        <Subheading className="text-[16px] text-neutral-500 leading-relaxed mb-8">Real-time updates via dedicated Slack channel. No middlemen.
                        </Subheading>
                    </CardDescription>
                    <CardContent>
                ...
                <Card className="flex-1 min-w-[345px] h-[500px] max-w-sm p-8">
                    <CardHeader className="flex flex-row flex-nowrap gap-4 items-center mb-6">
                        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-sm font-semibold text-neutral-600">3</span>
                        <CardTitle className="text-xs uppercase tracking-wider text-neutral-400 font-medium">Delivery</CardTitle>
                    </CardHeader>
                    <CardDescription>
                        <Subheading className="text-[16px] text-neutral-500 leading-relaxed mb-8">Design, build, and deploy. Most projects go live in under 72 hours
                        </Subheading>
                    </CardDescription>
                    <CardContent>
