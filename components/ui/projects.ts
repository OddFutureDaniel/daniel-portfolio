...
export const PROJECTS: Record<number, Project> = {
  ...
  1: {
    ...
    carousel: {
      ...
      },
      {
        type: "video",
        poster:
          "https://res.cloudinary.com/dzkjoraha/video/upload/so_0,f_jpg,q_auto/freecompress-Screen_Recording_2026-02-05_at_17.52.05_q7byzp.jpg",
        src: "https://res.cloudinary.com/dzkjoraha/video/upload/fl_progressive,q_auto/freecompress-Screen_Recording_2026-02-05_at_17.52.05_q7byzp.mp4",
        alt: "Video of Jaffa Saba Portfolio Site",
        frameWidth: 660,
        imageWidth: 660,
        mobile: { frameWidth: 450, imageWidth: 390 },
      },],
    },
  },
  ...
  3: {
    ...
    tech: "Shopify",
    description:
      "We designed and developed an immersive digital space for 730Carlina, drawing on early internet culture to present fashion items, imagery and archival pieces as a cohesive world.",
    carousel: {
      frameHeight: 385,
      mobileFrameHeight: 420,
      items: [
